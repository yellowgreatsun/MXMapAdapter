 ...
 * 设置楼层条每个Item 布局
 */
public class MapIndoorItem extends FrameLayout {
    ...
    public MapIndoorItem(Context context) {
        super(context);
        init();
    }

    public MapIndoorItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MapIndoorItem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        LayoutParams layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, dip2px(getContext(), ITEM_HEIGHT));
